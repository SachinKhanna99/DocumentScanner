        ...
        this.itemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( adapter.multiSelect ){
                    ...
                    String baseDirectory = v.getContext().getString(R.string.storage_path);
                    String newFileName = baseDirectory + document.getPath();
                    File toOpen = new File( sd, newFileName );

                    Uri sharedFileUri = FileProvider.getUriForFile(v.getContext(), "com.example.documentscanner.provider", toOpen);
