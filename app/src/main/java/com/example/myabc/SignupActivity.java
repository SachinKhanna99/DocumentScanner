...
public class SignupActivity extends AppCompatActivity {
    ...
    private void SaveData(String n, String em,String ph) {
        ...
        reference.child("Users").child(user).push().updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful())
                {
                    Intent i=new Intent(SignupActivity.this,UserDetail.class);
